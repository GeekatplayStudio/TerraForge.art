...
const std::vector<ShortcutCommand> &shortcut_commands() {
  static const std::vector<ShortcutCommand> t = {
      ...
      {"tool.twist", "Twist gizmo", "Tools", "T"},
      {"tool.bend", "Bend gizmo", "Tools", "B"},
      {"tool.skew", "Skew gizmo", "Tools", "K"},
      {"tool.taper", "Taper gizmo", "Tools", "J"},
      {"view.gizmos", "Show gizmos", "View", "Ctrl+G"},
