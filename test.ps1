...
Write-Host "`n[1/2] Running Native C++20 Test Suite..." -ForegroundColor Yellow
& .\build\nodeterrain_tests.exe
...
Write-Host "`n[2/3] Running TerraForge Engine Test Suite..." -ForegroundColor Yellow
...
Write-Host "`n[3/3] Running Python / Multi-Agent Test Suite..." -ForegroundColor Yellow
